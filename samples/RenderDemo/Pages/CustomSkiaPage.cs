                ...
                else
                {
                    ...
                    using (var sweep =
                        SKShader.CreateSweepGradient(new SKPoint((int)Bounds.Width / 2, (int)Bounds.Height / 2), colors,
                            null)) 
                    // TODO: using(var turbulence = SKShader.CreatePerlinNoiseFractalNoise(0.05f, 0.05f, 4, 0))
                    // TODO: using(var shader = SKShader.CreateCompose(sweep, turbulence, SKBlendMode.SrcATop))
