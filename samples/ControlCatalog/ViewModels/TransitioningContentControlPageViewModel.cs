...
{
    public class TransitioningContentControlPageViewModel : ReactiveObject
    {
        public TransitioningContentControlPageViewModel()
        {
            var images = new string[] 
            { 
                "delicate-arch-896885_640.png", 
                "hirsch-899118_640.png", 
                "maple-leaf-888807_640.png" 
            };
            ...
            NextImageCommand = ReactiveCommand.Create(NextImageImpl);
            PrevImageCommand = ReactiveCommand.Create(PrevImageImpl);
        }
    ...
    public class PageTransition : ReactiveObject
    {
