...
public class DataValidationViewModel : ReactiveObject
{
    ...
    public string? DataAnnotationsSample
    {
        ...
        set => this.RaiseAndSetIfChanged(ref _DataAnnotationsSample, value);
    }
    ...
    public string? ExceptionInsideSetterSample
    {
        ...
        set
        {
            ...
            this.RaiseAndSetIfChanged(ref _ExceptionInsideSetterSample, value);
        }
    }
