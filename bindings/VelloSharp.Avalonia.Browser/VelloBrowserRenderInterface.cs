...
internal sealed class VelloBrowserRenderInterface : IPlatformRenderInterface
{
    private readonly VelloPlatformOptions _options;

    public VelloBrowserRenderInterface(VelloPlatformOptions options)
    {
    ...
    {
        return new VelloBrowserRenderInterfaceContext(_options);
    }
    ...
    public IRenderTargetBitmapImpl CreateRenderTargetBitmap(PixelSize size, Vector dpi) =>
        throw new NotSupportedException("RenderTargetBitmap is not supported by the Vello browser renderer.");
    ...
    public IBitmapImpl ResizeBitmap(IBitmapImpl bitmapImpl, PixelSize destinationSize, BitmapInterpolationMode interpolationMode = BitmapInterpolationMode.HighQuality)
        => bitmapImpl is VelloBitmapImpl velloBitmap
            ...
            : throw new NotSupportedException("Bitmap implementation is not compatible with the Vello renderer.");
    ...
    private static void EnsureSupportedPixelFormat(PixelFormat format)
    {
        ...
        {
            throw new NotSupportedException($"Pixel format {format} is not supported by the Vello renderer.");
        }
    }
