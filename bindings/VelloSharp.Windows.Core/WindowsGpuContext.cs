...
public sealed class WindowsGpuContext : IDisposable
{
    ...
    public WindowsSwapChainSurface CreateSwapChainSurface(WindowsSurfaceDescriptor surfaceDescriptor, uint width, uint height)
    {
        ...
        var surfaceHandle = surfaceDescriptor.ToSurfaceHandle();
        ...
        try
        {
            ...
            return new WindowsSwapChainSurface(this, surface, surfaceHandle, format, _options.PresentMode, descriptor.Width, descriptor.Height);
        }
        catch
        {
            surface.Dispose();
