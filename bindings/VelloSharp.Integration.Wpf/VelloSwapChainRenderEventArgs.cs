...
{
    internal VelloSwapChainRenderEventArgs(WindowsGpuContextLease lease, WindowsSwapChainSurface surface, WindowsSurfaceSize pixelSize, TimeSpan timestamp, TimeSpan delta, long frameId)
    {
