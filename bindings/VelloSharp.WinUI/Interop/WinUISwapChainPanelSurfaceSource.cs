...
namespace VelloSharp.Windows.Interop;

internal sealed class WinUISwapChainPanelSurfaceSource : IWindowsSurfaceSource, IDisposable
{
    ...
    public WinUISwapChainPanelSurfaceSource(SwapChainPanel panel)
    {
